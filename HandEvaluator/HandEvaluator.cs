...
namespace HoldemHand
{
    ...
    public partial class Hand : IComparable
    {
        ...
        public static int NumSuits(ulong cards)
        {
            ...
            if (nBitsTable[sc] > max) max = nBitsTable[sc];
            if (nBitsTable[sd] > max) max = nBitsTable[sd];
            if (nBitsTable[sh] > max) max = nBitsTable[sh];
            if (nBitsTable[ss] > max) max = nBitsTable[ss];
